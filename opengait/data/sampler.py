...
class TripletSampler(tordata.sampler.Sampler):
    ...
    def __iter__(self):
        while True:
            ...
            # 再分布式计算中平均分配batch_size的大小
            total_size = int(math.ceil(total_batch_size /
                                       self.world_size)) * self.world_size
            # 确保采样的数量至少达到total——batch——size
