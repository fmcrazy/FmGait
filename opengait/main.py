...
parser.add_argument('--cfgs', type=str,
                    default='../configs/gaitset/gaitset.yaml', help="path of config file")

# GaitBase
# parser.add_argument('--cfgs', type=str,
#                     default='../configs/gaitbase/gaitbase_oumvlp.yaml', help="path of config file")

parser.add_argument('--phase', default='test',   # 将训练改为测试
